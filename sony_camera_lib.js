...
(function () {
  ...
  SonyCamera.prototype.callNew = function (method, params, callback) {
        var self = this;
        this.rpcReqNew.method = method;
        this.rpcReqNew.params = params || [];
        var postData = JSON.stringify(this.rpcReqNew);
  ...
  SonyCamera.prototype._processEventsNew = function (waitForChange, callback) {
